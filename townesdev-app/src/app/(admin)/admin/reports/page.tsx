    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Generate comprehensive monthly PDF reports for clients including
          rhythm activities, incidents, and billing information.
        </p>
      </div>
      ...
      <div className="mt-8 bg-gray-50 p-6 rounded-lg">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> Reports are generated in real-time from
            current data. For consistent monthly reports, generate them at the
            end of each month when all activities are complete.
          </p>
        </div>
      </div>
    </div>
