...
export const client: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      description: 'Monthly maintenance window (e.g., first Tuesday, 9:00–11:00 AM CT)',
    },
    {
      name: 'email',
      title: 'Email',
...
export const kickoffChecklist: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'boolean',
      description: 'Repo, hosting, monitoring, error logs, Discord application portal access confirmed',
    },
    {
      name: 'baselineSnapshot',
      title: 'Baseline Snapshot',
      type: 'text',
      description: 'Code tag, database backup, environment variables, and secrets',
    },
    {
      name: 'maintenanceWindow',
      title: 'Maintenance Window',
    ...
    },
    {
      ...
      title: 'Runbook',
      type: 'text',
      description: 'Deploy steps, rollback steps, secret rotation, incident severity levels',
    },
    {
      name: 'contactTree',
      title: 'Contact Tree',
    ...
    },
    {
      ...
      type: 'text',
      description: 'Monthly Change Log, Incidents, Next Patch Targets, Time Used vs Included Hours',
    },
  ],
}
...
export const monthlyRhythm: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      description: 'Dependencies updated, API deprecations reviewed, smoke tests, deployment',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      description: 'Small findings addressed (lint, types, deprecations) within included hours',
    },
    {
      name: 'week4Report',
      title: 'Week 4 - Report',
      type: 'text',
      description: 'Monthly report covering changes, uptime, risks, and recommendations',
    },
    {
      name: 'hoursUsed',
      title: 'Hours Used',
...
export const incident: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Workflow',
      type: 'text',
      description: 'Triage -> reproduce -> hotfix or rollback -> verification -> post-mortem',
    },
    {
      name: 'hoursUsed',
      title: 'Hours Used',
  ...
  fields: [
    {
      ...
      title: 'Template Name',
      type: 'string',
      description: 'Name of the email template (e.g., Retainer Proposal, Welcome Activation)',
    },
    {
      name: 'subject',
      title: 'Subject Line',
    ...
    },
    {
      ...
      type: 'text',
      rows: 10,
      description: 'The plain text email content. Use placeholders like {{clientName}}, {{planName}}, {{startDate}}, {{slaStartTime}}, {{maintenanceWindow}}, {{status}} to dynamically insert client information.',
    },
    {
      name: 'htmlBody',
      ...
      type: 'array',
      of: [{ type: 'block' }],
      description: 'Optional rich text HTML version of the email. If provided, this will be sent as HTML email. Use placeholders like {{clientName}} in the text.',
    },
    {
      name: 'purpose',
      title: 'Purpose',
